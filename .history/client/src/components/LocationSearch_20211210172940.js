...
// import './App.css'
import { Search, GpsFixed } from "@material-ui/core"
...
function LocationSearch() {
  ...
  const initMapScript = () => {
    ...
    const src = `${mapApiJs}?key=AIzaSyB8elomWP1QiWtBxQnatkC986I3ec2dl30&libraries=places&v=weekly`;
  ...
  const reverseGeocode = ({ latitude: lat, longitude: lng}) => {
    const url = `${geocodeJson}?key=AIzaSyB8elomWP1QiWtBxQnatkC986I3ec2dl30&latlng=${lat},${lng}`;
