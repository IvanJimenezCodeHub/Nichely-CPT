        ...
        <div >
          ...
          <div >
            ...
            <div className="map">
              ...
              {
              <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyB8elomWP1QiWtBxQnatkC986I3ec2dl30"></script>,
              function () {
                var autocomplete;
                autocomplete = new google.maps.places.Autocomplete((location.value.setState), {
                types: ['geocode'],
