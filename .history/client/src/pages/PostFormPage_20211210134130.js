...
class PostFormPage extends React.Component {
  ...
  handleSelect = async value => {
    var results = await geocodeByAddress(value);
    var latLng = await getLatLng(results[0]);
    this.eventLocationChanged(value);
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8elomWP1QiWtBxQnatkC986I3ec2dl30&libraries=places"></script>
