...
router.post('/', passport.isAuthenticated(), (req, res) => {
  let { eventName, eventDescription, eventLocation, latitude, logitude, eventTime, eventDate, relevantInterests, hostId } = req.body;
  let rsvpList = [];
  Event.create({ eventName, eventDescription, eventLocation, latitude, logitude, eventTime, eventDate, relevantInterests, hostId, rsvpList })
    .then(post => {
      console.log("created!");
